// To parse this data:
//
//   import { Convert, EndedMatches } from "./file";
//
//   const endedMatches = Convert.toEndedMatches(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface EndedMatchesRes {
	success: number
	pager: Pager
	results: EndedMatches[]
}
...
export class Convert {
	public static toEndedMatches(json: string): EndedMatches {
		return cast(JSON.parse(json), r('EndedMatches'))
	}

	public static endedMatchesToJson(value: EndedMatches): string {
		return JSON.stringify(uncast(value, r('EndedMatches')), null, 2)
	}
}
...
const typeMap: any = {
	...
	Result: o(
		[
			...
			{ json: 'ss', js: 'ss', typ: u(null, '') },
			{ json: 'round', js: 'round', typ: '' },
			{ json: 'scores', js: 'scores', typ: u(undefined, m(r('Score'))) },
