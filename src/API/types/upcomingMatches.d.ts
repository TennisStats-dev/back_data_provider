// To parse this data:
//
//   import { Convert, UpcomingMatches } from "./file";
//
//   const upcomingMatches = Convert.toUpcomingMatches(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface UpcomingMatchesRes {
	success: number
	pager: Pager
...
export class Convert {
	public static toUpcomingMatches(json: string): UpcomingMatches {
		return cast(JSON.parse(json), r('UpcomingMatches'))
	}

	public static upcomingMatchesToJson(value: UpcomingMatches): string {
		return JSON.stringify(uncast(value, r('UpcomingMatches')), null, 2)
	}
}
